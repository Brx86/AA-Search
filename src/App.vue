...
<template>
  <nav class="container-fluid">
    <ul>
      <li><a> <img id="logo" class="logo" src="./assets/logo.svg" width="30" height="30" /></a></li>
      <li><a href="https://wiki.archlinuxcn.org/wiki/Arch_Linux_Archive" target="_blank">Arch Linux Archive Search</a>
      </li>
    </ul>
    <ul>
      <li><a href="https://github.com/Brx86/AA-Search" target="_blank"><svg viewBox="0 0 496 512" width="20px">
            <path
